%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% * Thermal calculation for inverter operation
% * Project Go-Kart
% * Description:
...
% Inverter input parameters
    VDC   = 36;
    I_rms = 89.8;%175;%%263;%251
    I_pk  = 92.4;%180;%%371;%355.75;92.4;
    PF    = 0.76;
    phi   = acos(PF);
    fs    = 20000;
...
%        if Use_Fets_xlsx == 0
        ...
        Mosfet_name= ['IPT012N08N']
        R_DS_ON    = 1.4E-3;    %Corrected for current and temperatur
        tr         = 31E-9;
        tf         = 30E-9;
        trr        = 212E-9;
        Qg         = 223E-9;        %Coloumb
        Qrr        = 636E-9;
        R_thJC     = 0.4;
        V_plateau  = 4.5;           %See graph or datasheet table
        R_G        = 2.4;
        Crss_RI    = 3000E-12;
        Crss_VDC   = 90E-12;
